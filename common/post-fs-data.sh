...
echo "Executing command '${cmd}'"
su -c "sqlite3 /data/data/com.google.android.gms/databases/phenotype.db  \"UPDATE Flags SET boolVal=1 WHERE packageName LIKE '%messaging%' AND name LIKE '%MultiDeviceRollout__launched__%'\";"
echo "Command status is $?"
...
echo "Executing command '${cmd}'"
su -c "sqlite3 /data/data/com.google.android.gms/databases/phenotype.db  \"UPDATE Flags SET boolVal=1 WHERE packageName LIKE '%messaging%' AND name LIKE '%MultiQueueRollout__launched__%'\";"
echo "Command status is $?"
...
echo "Command status is $?"
# Enable material redesign
cmd="\"UPDATE Flags SET boolVal=1 WHERE packageName LIKE '%messaging%' AND name LIKE '%enable_phenotype_override%'\""
echo "Executing command '${cmd}'"
su -c "sqlite3 /data/data/com.google.android.gms/databases/phenotype.db  \"UPDATE Flags SET boolVal=1 WHERE packageName LIKE '%messaging%' AND name LIKE '%enable_phenotype_override%'\";"
echo "Command status is $?"
cmd="\"UPDATE Flags SET boolVal=1 WHERE packageName LIKE '%messaging%' AND name LIKE '%bugle_phenotype__enable_m2%'\""
echo "Executing command '${cmd}'"
su -c "sqlite3 /data/data/com.google.android.gms/databases/phenotype.db  \"UPDATE Flags SET boolVal=1 WHERE packageName LIKE '%messaging%' AND name LIKE '%bugle_phenotype__enable_m2%'\";"
echo "Command status is $?"
